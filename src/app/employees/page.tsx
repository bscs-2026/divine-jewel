...
import Layout from '../../components/PageLayout';  // Import the Layout component
...
export default function EmployeesPage() {
    ...
    return (
        <Layout defaultTitle="Employees"> {/* Correctly using Layout here */}
            <div className='container m-4'>
                <div className='input-form'>
                    <form onSubmit={editingEmployee ? saveEmployee : addEmployee}>
                        ...
                        <div className='mt-4'>
                            ...
                            <button type='submit' className='px-2 mx-2 border border-white'>
                ...
                <div className='employee-toggle-view'>
                    <button className='px-2 mx-1 mt-2 border border-white' onClick={() => setListView('active')}>
                        Active
                    </button>
                    <button className='px-2 mx-1 mt-2 border border-white' onClick={() => setListView('inactive')}>
                        Inactive
                    </button>
                </div>
                            ...
                            {(listView === 'active' ? activeEmployees : inactiveEmployees).map((employee) => (
                                <tr key={employee.id}>
                                    ...
                                    <td>
                                        {listView === 'active' ? (
                                            <>
                                                <button onClick={() => editEmployee(employee.id)} className='px-2'>
                                                    Edit
                                                </button>
                                                <button onClick={() => archiveEmployee(employee.id)} className='px-2'>
                                                    Archive
                                                </button>
                                            </>
                                        ) : (
                                            <button onClick={() => unarchiveEmployee(employee.id)} className='px-2'>
                                                Unarchive
                                            </button>
                                        )}
                                    </td>
