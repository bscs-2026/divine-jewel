...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        const result = await query(
            'INSERT INTO `suppliers` (supplier_name, contact_info, address, email, phone_number) VALUES (?, ?, ?, ?, ?)',
            [supplier_name, contact_info || null, address || null, email || null, phone_number || null]
        );
