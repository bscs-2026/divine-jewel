        ...
        <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row h-14">
          <div className="flex w-full">
            <button
              ...
              className={`relative z-30 flex flex-1 flex-col justify-center items-center gap-1 px-6 py-4 text-center bg-[#FCE4EC] rounded-tl-[0.75rem] ${activeView === "yearly" ? "bg-[#F9BDBB] font-bold" : "font-medium"
                }`}
            ...
            <button
              ...
              className={`relative z-30 flex flex-1 flex-col justify-center items-center gap-1 px-6 py-4 text-center bg-[#FCE4EC] border-l-0 border-r-0 ${activeView === "monthly" ? "bg-[#AED6F1] font-bold" : "font-medium"
                }`}
            ...
            <button
              ...
              className={`relative z-30 flex flex-1 flex-col justify-center items-center gap-1 px-6 py-4 text-center bg-[#FCE4EC] rounded-tr-[0.75rem] border-r-0 border-l ${activeView === "daily" ? "bg-[#AED6F1] font-bold" : "font-medium"
                }`}
